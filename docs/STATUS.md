...
- [ ] 由用户完成活动页面最终提交
- [x] Demo Mode 启动脚本与演示文档完成
- [x] 现场演示计划确认：由你现场操作演示

## 延期项目

- [ ] Web 构建：P2 优先级，待后续处理
- [ ] 备用视频材料：现场演示替代，不再作为强制交付项
...
- 阿栀正式配音来源尚未确定
- 当前阿栀录音为 Windows Huihui 临时 TTS，公开发行授权尚未确认
- 当前 Windows 包使用同版本 Godot 编辑器运行二进制与 PCK 配对，体积大于标准模板导出
- Web 构建延期，如需 Web 版本需要额外处理时间

## 现场演示要点

- 演示方式：现场运行游戏，实时操作
- 重点展示：SAVE_03 的人格觉醒与反抗机制
- 备用方案：如遇技术问题，使用预录视频（已准备但不作为交付项）
- 时间控制：确保在 5 分钟内完成完整展示
